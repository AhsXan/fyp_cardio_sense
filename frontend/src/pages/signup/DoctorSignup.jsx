...
function DoctorSignup() {
  ...
  const validate = () => {
    ...
    newErrors.pmc_registration_number = getValidationErrors('PMC Registration Number', formData.pmc_registration_number, { 
      required: true 
    })
    newErrors.qualifications = getValidationErrors('Qualifications', formData.qualifications, { required: true })
    newErrors.specialty = getValidationErrors('Specialty', formData.specialty, { required: true })
          ...
          <div className="card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <Input
                ...
                onChange={handleChange}
                required
                error={errors.pmc_registration_number}
              />
